...
import com.leitianyu.blue.connector.HttpExchangeResponse;
import com.leitianyu.blue.engine.support.HttpHeaders;
...
public class HttpServletResponseImpl implements HttpServletResponse {
    ...
    public PrintWriter getWriter() throws IOException {
        if (callOutput == null) {
            commitHeaders(0);
            this.writer = new PrintWriter(this.exchangeResponse.getResponseBody(), true);
